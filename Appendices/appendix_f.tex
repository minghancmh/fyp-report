...
\begin{lstlisting}[caption={\texttt{cloudkube} successful provisioning output}, breaklines=true, breakatwhitespace=false]
    ...
    aws_efs_mount_target.efs_mount_target_1: Still destroying... [id=fsmt-049b1cfd599b6d02f, 10s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still destroying... [id=fsmt-013a25d1fba50ba69, 10s elapsed]
    module.eks.module.kms.aws_kms_key.this[0]: Still creating... [10s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still destroying... [id=fsmt-049b1cfd599b6d02f, 20s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still destroying... [id=fsmt-013a25d1fba50ba69, 20s elapsed]
    ...
    aws_efs_mount_target.efs_mount_target_2: Still creating... [10s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [10s elapsed]
    module.eks.aws_eks_cluster.this[0]: Still creating... [10s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still creating... [20s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [20s elapsed]
    module.eks.aws_eks_cluster.this[0]: Still creating... [20s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still creating... [30s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [30s elapsed]
    module.eks.aws_eks_cluster.this[0]: Still creating... [30s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still creating... [40s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [40s elapsed]
    module.eks.aws_eks_cluster.this[0]: Still creating... [40s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still creating... [50s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [50s elapsed]
    module.eks.aws_eks_cluster.this[0]: Still creating... [50s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still creating... [1m0s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [1m0s elapsed]
    module.eks.aws_eks_cluster.this[0]: Still creating... [1m0s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still creating... [1m10s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [1m10s elapsed]
    module.eks.aws_eks_cluster.this[0]: Still creating... [1m10s elapsed]
    aws_efs_mount_target.efs_mount_target_2: Still creating... [1m20s elapsed]
    aws_efs_mount_target.efs_mount_target_1: Still creating... [1m20s elapsed]
    ...
    module.eks.aws_eks_addon.this["eks-pod-identity-agent"]: Still creating... [10s elapsed]
    ...
    module.eks.aws_eks_addon.this["eks-pod-identity-agent"]: Still creating... [20s elapsed]
    module.eks.aws_eks_addon.this["eks-pod-identity-agent"]: Still creating... [30s elapsed]
    module.eks.aws_eks_addon.this["vpc-cni"]: Still creating... [30s elapsed]
    module.eks.aws_eks_addon.this["eks-pod-identity-agent"]: Still creating... [40s elapsed]
